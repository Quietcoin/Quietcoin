...
unsigned int nStakeMinAge = 60 * 60 * 24 * 7;	//1 week for stake age
unsigned int nStakeMaxAge = 60 * 60 * 24 * 14;	//2 weeks for stake full mature
unsigned int nStakeTargetSpacing = 120;			// 2 minute block spacing

int64 nChainStartTime = 1406821955;
...
const string strMessageMagic = "Quietcoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight == 1) {nSubsidy = 100000 * COIN;} // IPO Premine
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    nRewardCoinYear = MAX_QUIET_PROOF_OF_STAKE;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Quietcoin
    bool fStrictPayToScriptHash = true; // Always active in Quietcoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Quietcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Shhh! Quietcoin takes the world by storm!";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xe19dd6da951b07a36232ada145aa2f9928d2dc97369054c61b8377806d53dec1"));
...
unsigned char pchMessageStart[4] = { 0xde, 0xde, 0x01, 0x04 };
